...
export default function Gauge({ state }: { state: State<any> }) {
  return (
    <div className="container">
      ...
      <div
        className={classNames('gauge-inner', {
          running: state.matches('EngineRunning'),
        })}
      >
        <div className="on-off-led">on</div>
        <div className="other-leds">
          <div
            className={classNames('low-fuel-led', {
              on: state.context.lowFuelWarning,
            })}
          />
          <div
            className={classNames('low-battery-led', {
              on: state.context.lowBatteryWarning,
            })}
          />
        </div>
      </div>
